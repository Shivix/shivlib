...
BOOST_AUTO_TEST_SUITE(matrix_test)
    BOOST_AUTO_TEST_CASE(multiply_test){
        ...
        shiv::matrix<int, 3, 3> matrix1i = {
                {{{0, 1, 2},
                         {3, 4, 5},
                         {6, 7, 8}
                 }}};
        shiv::matrix<int, 3, 3> matrix2i = {
                {{{0, 1, 2},
                         {3, 4, 5},
                         {6, 7, 8}
                 }}};
        ...
        shiv::matrix<int, 3, 3> expectedMatrixi = {
                {{{15, 18, 21},
                         {42, 54, 66},
                         {69, 90, 111}
                 }}};
        shiv::matrix<float, 3, 3> expectedMatrix2 = {
                {{{0, 5, 10},
                         {15, 20, 25},
                         {30, 35, 40}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(divide_test){
        ...
        shiv::matrix<double, 3, 3> expectedMatrix2 = {
                {{{2, 3, 4},
                         {1, 1.2, 1.6},
                         {2.8, 1.4, 17.6}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(addition_test){
        ...
        shiv::matrix<float, 3, 3> expectedMatrix12 = {
                {{{0, 2, 4},
                         {6, 8, 10},
                         {12, 14, 16}
                 }}};
        shiv::matrix<float, 3, 3> expectedMatrix1S = {
                {{{7, 8, 9},
                         {10, 11, 12},
                         {13, 14, 15}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(subtraction_test){
        ...
        shiv::matrix<float, 3, 3> negMatrix = {
                {{{-0, -1, -2},
                         {-3, -4, -5},
                         {-6, -7, -8}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(determinant_test, *boost::unit_test::tolerance(0.01)){
        ...
        shiv::matrix<float, 2, 2> matrix2x2 = {
                {{{0, 1},
                         {3, 4}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(row_echelon_test, *boost::unit_test::tolerance(0.01)){
        ...
        shiv::matrix<float, 3, 3> expectedMatrix3x3 = {
                {{{3, 4, 5},
                         {0, 1, 2},
                         {0, 0, 0}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(augment_test){
        ...
        shiv::matrix<float, 3, 3> matrix3x32 = {
                {{{0, 1, 2},
                         {3, 4, 5},
                         {6, 7, 8}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(sort_test){// helps check begin and rebegin iterators.
        ...
        shiv::matrix<float, 3, 3> expectedReversed = {
                {{{8, 7, 7},
                         {5, 5, 5},
                         {3, 2, 1}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(swap_test){
        ...
        shiv::matrix<int, 3, 3> matrix3x32 = {
                                             {{{3, 7, 0},
                                               {5, 1, 2},
                                               {5, 2, 5}
                 }}};
        shiv::matrix<int, 3, 3> matrix3x3R = {
                {{{3, 7, 0},
                         {5, 1, 2},
                         {5, 2, 5}
                 }}};
        shiv::matrix<int, 3, 3> matrix3x32R = {
                {{{0, 1, 2},
                         {3, 4, 5},
                         {6, 7, 8}
                 }}};
    ...
    BOOST_AUTO_TEST_CASE(at_test){
        ...
        const shiv::matrix<int, 3, 3> matrix3x3c = {
                {{{0, 1, 2},
                         {3, 4, 5},
                         {6, 7, 22}
                 }}};
